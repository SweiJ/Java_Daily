...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/online-generator/src/main/java");
        gc.setAuthor("swei"); //作者
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/online-generator/src/main/resources/mapper/" + pc.getModuleName()
